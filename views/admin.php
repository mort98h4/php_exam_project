...
<div class="grid grid-cols-12 mx-auto mt-12 gap-4 p-4 relative">
    ...
    <main class="col-span-8">
        ...
        <section id="allUsers" class="pt-12">
            ...
            <article id="user_<?= out($user['user_id']) ?>" class="user">
                ...
                <p>E-mail: <span class="email"><?= out($user['user_email']) ?></span></p>
                <p>Role: <span class="role"><?= out($user['role_name']) ?></span></p>
            </article>
            <?php } ?>
        ...
        <section id="allBeers" class="pt-12">
            ...
            <article id="beer_<?= out($beer['beer_id']) ?>" class="beer">
                ...
                <div class="grid grid-cols-3 gap-4 items-start">
                    <div class="col-span-2 grid gap-2 grid-cols-2 items-start">
