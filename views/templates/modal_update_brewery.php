        ...
        <form class="w-full flex flex-wrap gap-4">
            ...
            <div class="form-control-full">
                <div class="relative w-full">
                    <input class="dynamic-input" type="text" name="name" id="update_brewery_name" required minlength="<?= _STR_MIN_LEN ?>" maxlength="<?= _STR_MAX_LEN ?>" placeholder=" " />
                    <div class="label-container">
                        <label class="dynamic-label" for="update_brewery_name">Name</label>
                    </div>
                </div>
